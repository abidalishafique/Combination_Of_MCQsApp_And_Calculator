    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem)
            {
                switch (menuItem.getItemId())
                {
                    ...
                    case R.id.myquiz :
                        ...
                        break;
                    case R.id.assign3 :
                        Toast.makeText(getApplicationContext(),"Going to the Start of the Activity",Toast.LENGTH_LONG).show();
        ...
        for(int i=0;i<result.length;i++)
        {
            ...
            else
            {
                ...
                val += "You Choosed :  '"+option[0]+"'\n";
                val+="But Right Answer is: '"+option[1]+"'\n";
                wrongMCQS.add(val);
            }
        }
